...
--Permutacion de una lista----------------------------------------------------------------------------------------
--Pasa el ultimo elemento de la lista al inicio
ciclo [] = []
ciclo xs = (last xs ) : (init xs) 

--Mayor número de 2 cifras con dos digitos dados (OJO que es digito y no número)--------------------------------------------  
--numeroMayor 2 5 == 52     numeroMayor 5 2 == 52
numeroMayor a b = mayor*10 + menor
        where mayor = max a b --maximum [a,b]
              menor = min a b --minimum [a,b]
